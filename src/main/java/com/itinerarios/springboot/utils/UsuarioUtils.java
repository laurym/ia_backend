...
public class UsuarioUtils {
	...
	public static UsuarioReqInfoForm getUsuario(String token) throws JsonMappingException, JsonProcessingException, IOException {
		...
		Request request = new Request.Builder().url("https://ssoia.herokuapp.com/Usuarios/"+JWTUtils.getId(token))
				.method("GET", null)
				.addHeader("x-api-key", ConstantsUtil.API_KEY).addHeader("Authorization", token.substring(7))
